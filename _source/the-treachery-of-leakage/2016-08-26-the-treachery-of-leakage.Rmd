...
```{r, include=FALSE}
d1 <- structure(list(CUSTOMER = structure(c(2L, 3L, 4L, 5L, 6L, 1L), .Label = c("...", 
...
d2 <- structure(list(CUSTOMER = structure(c(2L, 3L, 4L, 5L, 6L, 1L), .Label = c("...", 
"45220", "45221", "45222", "45223", "45224"), class = "factor"), 
    HELP_DESK_CALLS_2015 = structure(c(5L, 2L, 3L, 5L, 4L, 1L
    ), .Label = c("...", "0", "1", "3", "4"), class = "factor"), 
    DOWNTIME_MINS_2015 = structure(c(4L, 2L, 5L, 3L, 6L, 1L), .Label = c("...", 
    "0", "1001", "1293", "43", "6298"), class = "factor"), CHURNED = structure(c(2L, 
    3L, 3L, 2L, 2L, 1L), .Label = c("...", "FALSE", "TRUE"), class = "factor"), 
    ... = structure(c(1L, 1L, 1L, 1L, 1L, 1L), .Label = "...", class = "factor")), .Names = c("CUSTOMER", 
"HELP_DESK_CALLS_2015", "DOWNTIME_MINS_2015", "CHURNED", "..."
